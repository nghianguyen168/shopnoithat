          ...
          <div class="col-xs-12"> 
            ...
            <div class="toplinks">
              <div class="links">
                ...
                <div class="check"><a title="Checkout" href="checkout.html"><span class="hidden-xs">Thủ tục thanh toán</span></a></div>
          ...
          <div class="search-box">
            <form action="http://htmldemo.magikcommerce.com/ecommerce/inspire-html-template/furniture/cat" method="POST" id="search_mini_form" name="Categories">
              <select name="category_id" class="cate-dropdown hidden-xs">
                ...
                <option value="36">&nbsp;&nbsp;Bàn</option>
                <option value="37">&nbsp;&nbsp;Ghế</option>
                <option value="38">&nbsp;&nbsp;Tủ</option>
                <option value="39">&nbsp;&nbsp;Bếp</option>
                <option value="40">&nbsp;&nbsp;Salon</option>
                <option value="41">&nbsp;&nbsp;Giường</option>
              </select>
