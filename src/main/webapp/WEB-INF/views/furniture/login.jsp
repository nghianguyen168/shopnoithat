          ...
          <div class="col-1 new-users"><strong>NHỮNG KHÁCH HÀNG MỚI</strong>
            <div class="content">
              ...
              <div class="buttons-set">
                <button onclick="window.location='http://demo.magentomagik.com/computerstore/customer/account/create/';" class="button create-account" type="button"><span>TẠO TÀI KHOẢN</span></button>
              </div>
            </div>
          </div>
