			...
			<div class="widget-body">
				<div class="widget-main">
					<div id="piechart-placeholder" style="width: 90%; min-height: 150px; padding: 0px; position: relative;">
						<canvas class="flot-base" width="558" height="187" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 447px; height: 150px;"></canvas>
						<canvas class="flot-overlay" width="558" height="187" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 447px; height: 150px;"></canvas>
						<div class="legend">
