...
<div class="row">
	<ul class="nav nav-tabs tab-setting" style="padding-left: 20px;">
		<li role="" ><a href="${pageContext.request.contextPath}/admin/sanpham/index"><i class="fa fa-user"></i> Sản phẩm</a></li>
		<li role=""><a href="${contextPath}/index"><i class="fa fa-truck"></i> Loại sản phẩm</a></li>
	</ul>
	<div class="col-xs-12">
		<div>
			<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
				<div class="row">
					<div class="col-md-6">
						<a href="${contextPath}/add" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Thêm danh mục</a> &nbsp;
					</div>
					<div class="col-xs-6">
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
					<thead>
						<tr role="row">
							...
							<th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending">Mã DM sản phẩm</th>
							<th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending">Tên DM sản phẩm</th>
							<th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending">Chú thích</th>
							<th class="sorting_disabled" rowspan="1" colspan="1" aria-label=""></th>
						</tr>
					</thead>

					<tbody>
						<c:if test="${not empty listDMSP}">
							<c:forEach items="${listDMSP}" var="dmsp">
								<c:set var="urlEdit" value="${contextPath}/edit/${dmsp.id}" />
								<c:set var="urlDel" value="${contextPath}/del/${dmsp.id}" />
