...
<div class="row">
	<ul class="nav nav-tabs tab-setting" style="padding-left: 20px;">
		<li role=""><a href="${pageContext.request.contextPath}/admin/phieunhap/index"><i class="fa fa-user"></i> Phiếu nhập</a></li>
		<li role=""><a href="${contextPath}/index"><i class="fa fa-truck"></i> Phiếu xuất</a></li>
	</ul>
	<div class="col-xs-12">
		<div>
			<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
				<div class="row">
					<div class="col-md-6">
						<a href="${contextPath}/add" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Thêm phiếu xuất</a> &nbsp;
					</div>
					<div class="col-xs-6">
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
					<thead>
						<tr role="row">
							...
							<th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending">Mã phiếu xuất</th>
							...
							<th class="hidden-480 sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending">Nguời nhận</th>
					...
					<tbody>
						<c:if test="${not empty listPhieuXuat}">
							<c:forEach items="${listPhieuXuat}" var="px">
								<c:set var="urlEdit" value="${contextPath}/edit/${px.id}" />
								<c:set var="urlDel" value="${contextPath}/del/${px.id}" />
								<c:set var="detail" value="${pageContext.request.contextPath}/admin/ctphieuxuat/detail/${px.id}" />
