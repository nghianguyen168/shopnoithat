...
<div class="step-pane active" data-step="1">
	<h3 class="lighter block green">THÊM PHIẾU XUẤT</h3>
	<form class="form-horizontal" id="sample-form" action="${contextPath}/add" method="post">
		...
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="date" id="inputWarning" name="ngayInHD" class="width-100">
				</span>
			</div>
		</div>
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="text" id="inputWarning" name="nguoiNhan" class="width-100">
				</span>
			</div>
		</div>
		<div class="form-group has-success">
