	...
	<form action="${contextPath}/add" method="post" class="form-horizontal" id="sample-form" enctype="multipart/form-data">
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="text" id="inputWarning" name="tenSanPham" class="width-100">
				</span>
			</div>
		</div>
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="text" id="inputWarning" name="donViTinh" class="width-100">
				</span>
			</div>
		</div>
		...
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="text" id="inputWarning" name="soLuongTon" class="width-100">
				</span>
			</div>
		</div>
		<div class="form-group has-success">
		...
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="text" id="inputWarning" name="thue" class="width-100">
				</span>
			</div>
		</div>
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="text" id="inputWarning" name="giaGoc" class="width-100">
				</span>
			</div>
		</div>
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <input type="text" id="inputWarning" name="giaKhuyenMai" class="width-100">
				</span>
			</div>
		</div>
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="file" name="hinhanh" class="width-100">
		...
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="file" name="hinhanhmota" multiple="multiple" class="width-100">
		...
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<input type="text" name="sao" class="width-100">
		...
		<div class="form-group has-success">
			...
			<div class="col-xs-12 col-sm-5">
				<span class="block input-icon input-icon-right"> <textarea id="description" name="moTaSanPham" class="width-100"></textarea>
				</span>
			</div>
		</div>
