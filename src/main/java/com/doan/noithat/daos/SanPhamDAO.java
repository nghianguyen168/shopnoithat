...
public class SanPhamDAO {
	...
	private static final String ADD_SANPHAM = "INSERT INTO sanpham(TenSanPham,MoTaSanPham,DonViTinh,SoLuongTon,IDDanhMucSP,IDNhaCungCap,Thue,GiaGoc,GiaKhuyenMai,HinhAnh,Sao) value(?,?,?,?,?,?,?,?,?,?,?)";
